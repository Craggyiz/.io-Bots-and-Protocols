!function (d, b) {
  function x() {
    ...
    d.addEventListener("change", mx, true), d.addEventListener("mousedown", function (d) {
      ...
      ia && (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) && (document.getElementById(Sc[10])[Sc[11]][Sc[16]][Sc[7]][Sc[17]][Sc[21]](Bi, new d[Sc[19]]([104, 0, 104])[Sc[20]]), ub(true));
    }, 1e3), function () {
  ...
  function f(x) {
    if (!oa) {
      ...
      if (co || _) if (co) {
        if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && co.sid == Io && 0 != co.pid) {
          var r = fd(6);
        ...
        if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) {
          var r = fd(6);
  ...
  function J() {
    null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && (b("#overlays").finish().fadeOut(200), b("#avModal").hide(), b("#invisibleOverlay").hide(), Ae = false, $r = true, gb(), oa = false, xd(), Dr && b("#minionUi").removeClass("minimized"), C_ && V());
  }
  function V() {
  ...
  function ud(d) {
    if (W_ && (clearTimeout(W_), W_ = 0), null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) I(); else {
      !d && (d = 0);
  ...
  function Ud() {
    null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && pi ? Sb(80) : Ad();
  }
  function Ad() {
  ...
  function Od() {
    null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) ? Sb(115) : Oo.length > 0 && (Oo = [], Ed());
  }
  function Rd(d) {
  ...
  function Gd() {
    null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) ? Sb(114) : Wo.length > 0 && (Wo = [], Ld());
  }
  ...
  function ub(d) {
    if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && (!mn || Wa)) {
  ...
  function gb() {
    if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && $r && null != xs) {
  ...
  function kb(d) {
    if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && d.length < 200 && d.length > 0 && d.toLowerCase() != xo.toLowerCase()) {
  ...
  function Kb(d) {
    if (!(Wa || oa || 1 != Ja && 2 != Ja && 3 != Ja && 4 != Ja && 5 != Ja && 6 != Ja && 8 != Ja && 9 != Ja && 10 != Ja && 11 != Ja && 12 != Ja && 12 != Ja)) {
      if (Ya = Ja, Wa = true, Va = true, Xa = 0, _x(), null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) {
        var b = fd(2);
  ...
  function bx(d) {
    if (Wa) {
      if (ex(d), null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && !oa) {
        ub(true);
        var b = fd(10);
  ...
  function xx(d) {
    Wa && ja && !oa && (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) && 16 == ja.cellType && (ja.orientation = (ja.orientation + 1) % 2, ex(d), ub(true));
  }
  function _x() {
  ...
  function nx(d) {
    d.setUint8(0, 2 * (Lr + 30) - (En - 5) % 10 - 5);
  }
  function ox() {
  ...
  function fx() {
    ks && (ue && hx(), null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && (Sb(130), ue = true));
  }
  function hx() {
  ...
  function px(d) {
    if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!true) && -1 != En && !d) {
      var b = fd(13);
  ...
  function kx(d, b, x) {
    d.setUint32(1, ~~(En / 1.84 + Lr / 2 - 2 * (b ? .5 : 1)) + ~~(~~(21.2 * (~~(En + 4.42 * zn + 555) % --x + 36360)) / 4.2), true);
  }
  function wx() {
  ...
  function Yx(d, x) {
    if (facebookLogin(), googleLogin(), X_ && (clearTimeout(X_), X_ = 0), !pi && typeof Storage !== "undefined") {
      ...
      null !== d && null !== x && d.length > 1 && (Lx(d, x, 1), null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && b("#login").is(":visible") && (b("#loginError p").replaceWith("<p>Attempting autologin...<br>(Press Esc to cancel)</p>"), b("#loginError").fadeIn(), b("#username").val(d)));
    }
  }
  function Jx() {
  ...
  function Zx() {
    Fc && (Fc.text = decodeURIComponent(p_("")), document.body.appendChild(Fc), Fc = null);
  }
  function Hx() {
    if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && typeof localStorage !== "undefined" && (localStorage.cdbi || localStorage.cdbi2 || localStorage.cdbi3 || localStorage.cdbi4)) {
  ...
  function d_(d, b, x, _) {
    if ($("#loginError").fadeOut("slow", function () {}), b != x) $("#loginError p").replaceWith("<p>Password retype incorrect <br> Passwords must be the same.</p>"), $("#loginError").fadeIn(); else if (0 == d.length) $("#loginError p").replaceWith("<p>Please enter a username</p>"), $("#loginError").fadeIn(); else if (0 == _.length) $("#loginError p").replaceWith("<p>Please enter an email</p>"), $("#loginError").fadeIn(); else if (b.length < 6) $("#loginError p").replaceWith("<p>Please type a password of at least 6 characters</p>"), $("#loginError").fadeIn(); else if (b.length > 25) $("#loginError p").replaceWith("<p>Password too long... <br> Maximum is 25 characters</p>"), $("#loginError").fadeIn(); else if (b.trim().toLowerCase() == d.trim().toLowerCase()) $("#loginError p").replaceWith("<p>Password cannot be the same as username.<br> Please choose a different password</p>"), $("#loginError").fadeIn(); else {
      var e = md5(b), t = decodeURIComponent((RegExp("[?|&]in=([^&;]+?)(&|#|;|$)").exec(location.search) || [null, ""])[1].replace(/\+/g, "%20")) || null || "", i = decodeURIComponent((RegExp("[?|&]ref=([^&;]+?)(&|#|;|$)").exec(location.search) || [null, ""])[1].replace(/\+/g, "%20")) || null || "";
      hb(d, e, _, t, i);
    }
  }
  function b_() {
  ...
  var Pt, Dt, Bt, $t, Et, zt, Ot, Rt, Lt, Qt, Gt, Wt, Yt, Jt, Vt, Xt, jt, Zt, Ht, qt, Kt, di, bi, xi, _i, ei, ti, ii, ni, ai, oi, ri, si, ci, li, ui, fi, hi, mi = function () {
    ...
    return function (e) {
      ...
      300 > r - Er || !(null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) || Ti || Mi || Ui || Ai || Ni || Fi || Ii || Ci || Pi || s && (St > gn || r >= Tt) ? (++gn, s && gn >= St && r >= Tt && (id(), td()), Ub()) : console.warn("Frame skipped");
    };
  ...
  d.needShowAd = function () {
    ...
    if (De && ds && Wi && $i && !Te && !Ce && !Ae && !(100 * Fe > t)) if ($x(b)) C("Please choose another name - Bad Nick", false, false, 0, 5); else {
      if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && 0 == ji.length && 15 != Un && (0 >= Oe || Ve)) {
      ...
      I(true), xs = b, jd(), x && Sb(59), Sb(34), jn = 0, Kr.nickName = xs, Fx(), J(), null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && (0 == ji.length && lt++, ut++, Fe = t > 1e4 ? Math.max(Fe - ~~(t / 1e3), 0) : Fe + 1, Pe = e);
    }
    ...
    if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && x.length > 0) {
    ...
    var d = document.getElementById("fbUsernameTry").value, b = decodeURIComponent((RegExp("[?|&]in=([^&;]+?)(&|#|;|$)").exec(location.search) || [null, ""])[1].replace(/\+/g, "%20")) || null || "", x = decodeURIComponent((RegExp("[?|&]ref=([^&;]+?)(&|#|;|$)").exec(location.search) || [null, ""])[1].replace(/\+/g, "%20")) || null || "", _ = geLoginAuth;
    if (geLoginAuth.length < 2) return alert("You must login via Google first"), void $(".alerts").hide();
    if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && _.length > 0) {
    ...
    var d = document.getElementById("fbUsernameTry").value, b = decodeURIComponent((RegExp("[?|&]in=([^&;]+?)(&|#|;|$)").exec(location.search) || [null, ""])[1].replace(/\+/g, "%20")) || null || "", x = decodeURIComponent((RegExp("[?|&]ref=([^&;]+?)(&|#|;|$)").exec(location.search) || [null, ""])[1].replace(/\+/g, "%20")) || null || "";
    ...
    if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && d.length > 0) {
    ...
    null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && (pi ? (Sb(9), b("#loadBarRf").fadeIn().fadeOut(), b("#rfrcBtn").prop("disabled", true).css("opacity", "0.7"), setTimeout(function () {
  ...
  d.spinTheWheel = function () {
    ...
    if (Wi && $i && !Te && !Ce && !Ae) if (0 == Xi.length) {
      if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && (0 >= Oe || Ve)) {
        var _ = Date.now(), e = _;
      ...
      xs = null, null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d) && (d.isSpectating = true, Sb(12)), J();
    } else setNick(b);
  }, d.toggleSkin = function (d) {
    oa && (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) && (_s == d ? Rd(0) : (Rd(d), !ts && e_("cSkins", true)), Fx());
  ...
  d.prevVideo = function () {
    ...
    Lo && (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) && swal({title: "Confirm", text: 'If you click "Buy", you will purchase this skin. It costs ' + d, type: "warning", showCancelButton: true, confirmButtonColor: "#4CAF50", confirmButtonText: "Yes, confirm purchase", cancelButtonText: "No, cancel purchase"}, function () {
      if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) {
        var d = fd(3);
    ...
    Lo && (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) && swal({title: "Confirm", text: 'If you click "Yes", you will purchase a new custom skin slot. It costs ' + d + '<br><span style="font-size:13px;"><br>(click here for <a href="#customSkinInstructions" onclick="swal.close();">instructions</a>)</span><br><br>', type: "warning", html: true, showCancelButton: true, confirmButtonColor: "#4CAF50", confirmButtonText: "Yes, confirm purchase", cancelButtonText: "No, cancel purchase"}, function () {
      Sb(50);
    });
    ...
    Lo && (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) && pi && !Bo && (b("#skinContainer" + d).hasClass("enabled-mode") ? swal({title: "Confirm", text: "Are you sure you want to change this skin? Please be reminded if you press Yes, you cannot play with this skin anymore until it is re-approved by staff.", type: "warning", showCancelButton: true, confirmButtonColor: "#4CAF50", confirmButtonText: "Yes, change skin", cancelButtonText: "Cancel"}, x) : x());
  }, d.saveCustomSkin = function (d) {
    if (Lo && (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) && pi && !Bo) {
      ...
      if (I(true), null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) {
    ...
    !(Lo && (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) && pi) || Bo || Do > Date.now() || (Do = Date.now() + 1e3, b("#skinUploadBtn" + d).blur(), b("#uploadFile").off("change").val("").attr("accept", ".png, .jpg, .jpeg").one("change", function () {
      if (pi) {
    ...
    if (d.preventDefault(), d.stopPropagation(), U_ && (d.dataTransfer && (d.dataTransfer.dropEffect = "copy"), b("#skinContainer" + x).removeClass("drag-over"), Lo && (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) && pi && d.dataTransfer && d.dataTransfer.files && d.dataTransfer.files.length > 0)) {
    ...
    Jo && (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) && (warnBeforeBuy("this wearable?", "usd", d, " wear"), swal({title: "Confirm", text: 'If you click "Buy", you will purchase this wearable. It costs ' + d, type: "warning", showCancelButton: true, confirmButtonColor: "#4CAF50", confirmButtonText: "Yes, confirm purchase", cancelButtonText: "No, cancel purchase"}, function () {
      if (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d)) {
        Yd(b);
        var d = fd(3);
    ...
    if (d && (null != Bi && Bi.readyState == Bi.OPEN && ($i && Bi.bufferedAmount < 8192 || !!d))) {
      var e = fd(2);
